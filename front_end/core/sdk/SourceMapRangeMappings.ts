 ...
 */
export function interpolateOriginalPosition(
    rangeMapping: RangeMappingStart, lineNumber: number, columnNumber: number): Position {
 ...
 */
export function interpolateGeneratedPosition(
    rangeMapping: RangeMappingStart, lineNumber: number, columnNumber: number): Position {
